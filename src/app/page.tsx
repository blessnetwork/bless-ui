...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
	...
	return (
		<div id="container" className="flex min-h-screen w-full">
			...
			>
				{/* Sidebar Header */}
				<div className="bg-gray-300 flex h-[40px] items-center justify-between p-2">
					<span className="text-sm font-bold text-black md:text-base">Logo</span>
					<button onClick={toggleSidebar} className="hover:bg-gray-400 rounded p-1">
						<Menu size={20} />
					</button>
				</div>
