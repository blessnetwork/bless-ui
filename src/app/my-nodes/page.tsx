...
// Chart Configuration
const chartConfig = {
	'Referral Time': { color: '#1E88E5' }, // Blue (Bottom)
	'Bonus Time': { color: '#43A047' }, // Green (Middle)
	'Base Time': { color: '#F4511E' } // Red (Top)
}
				...
				<ChartContainer config={chartConfig}>
					<ResponsiveContainer width="100%" height={400}>
						<BarChart data={chartData} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
							...
							<Tooltip />
							<Legend />
							<Bar dataKey="Referral Time" stackId="a" fill="#1E88E5" />
							<Bar dataKey="Bonus Time" stackId="a" fill="#43A047" />
							<Bar dataKey="Base Time" stackId="a" fill="#F4511E" />
						</BarChart>
					</ResponsiveContainer>
				</ChartContainer>
			</div>
